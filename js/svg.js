...
var slides = document.querySelectorAll('#slides .slide'),
    currentSlide = 0,
    full = document.querySelectorAll('.slider-nav > span'),
    currentButton = 0
full[currentButton].style.background = '#00897b'
  function nextSlide(a) {
    slides[currentSlide].className = 'slide';
    currentSlide = a;
    slides[currentSlide].className = 'slide showing';
    full[a].style.background = '#00897b'
    full[currentButton].style.background = 'white'
    currentButton = a
  }
// конец кода слайдера
  // const works = [
  ...
  // скрывает header при прокрутки вниз
  var lastScrollTop = 0;
  var current = document.getElementsByClassName('navbar')
  ...
  window.addEventListener("scroll", function(){
     ...
     lastScrollTop = st;
     var activeAnchor = console.log(document.querySelectorAll('a[href^="#"]'));
     var elem = document.getElementById('OurServices')
     var pop =  elem.getBoundingClientRect()
     console.log(pop.y);
